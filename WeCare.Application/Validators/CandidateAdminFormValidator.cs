...
public class CandidateAdminFormValidator : AbstractValidator<CandidateAdminForm>
{
    ...
    public CandidateAdminFormValidator(CandidateRepository candidateRepository)
    {
    ...
    private async Task<bool> UniqueEmail(CandidateAdminForm form, string email)
    {
        return !await _candidateRepository.ExistsByIdNotAndEmail(form.Id, email);
    }
    
    private async Task<bool> UniqueTelephone(CandidateAdminForm form, string telephone)
    {
        return !await _candidateRepository.ExistsByIdNotAndTelephone(form.Id, telephone);
    }
    
    private async Task<bool> UniqueCpf(CandidateAdminForm form, string cpf)
    {
