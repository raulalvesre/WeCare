    ...
    public partial class AddVolunteerOpportunity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    opportunity_cause_id = table.Column<int>(type: "integer", nullable: false),
                    name = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_opportunity_causes", x => x.opportunity_cause_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    causes_opportunity_cause_id = table.Column<int>(type: "integer", nullable: false),
                    volunteer_opportunities_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_opportunity_cause_volunteer_opportunity", x => new { x.causes_opportunity_cause_id, x.volunteer_opportunities_id });
                    table.ForeignKey(
                        name: "fk_opportunity_cause_volunteer_opportunity_opportunity_cause_c",
                        column: x => x.causes_opportunity_cause_id,
                        principalSchema: "public",
                        principalTable: "opportunity_causes",
                        principalColumn: "opportunity_cause_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "opportunity_cause_id", "name" },
                values: new object[,]
                {
                    { 1, "POLITICS" },
