...
namespace WeCare.Infrastructure.Migrations
{
    ...
    [Migration("20230523204103_AddParticipationCertificate")]
    partial class AddParticipationCertificate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandidateQualification", b =>
                {
                    ...
                    b.HasKey("CandidatesId", "QualificationsId")
                        .HasName("pk_candidate_qualification");

                    b.HasIndex("QualificationsId")
                        .HasDatabaseName("ix_candidate_qualification_qualifications_id");

                    b.ToTable("candidate_qualification", "public");
                });
            ...
            modelBuilder.Entity("ParticipationCertificateQualification", b =>
                {
                    b.Property<long>("DisplayedQualificationsId")
                        .HasColumnType("bigint")
                        .HasColumnName("displayed_qualifications_id");

                    b.Property<long>("ParticipationCertificatesId")
                        .HasColumnType("bigint")
                        .HasColumnName("participation_certificates_id");

                    b.HasKey("DisplayedQualificationsId", "ParticipationCertificatesId")
                        .HasName("pk_participation_certificate_qualification");

                    b.HasIndex("ParticipationCertificatesId")
                        .HasDatabaseName("ix_participation_certificate_qualification_participation_certi");

                    b.ToTable("participation_certificate_qualification", "public");
                });

            modelBuilder.Entity("QualificationVolunteerOpportunity", b =>
                {
                    b.Property<long>("DesirableQualificationsId")
                        .HasColumnType("bigint")
                        .HasColumnName("desirable_qualifications_id");

                    b.Property<long>("OpportunitiesId")
                        .HasColumnType("bigint")
                        .HasColumnName("opportunities_id");

                    b.HasKey("DesirableQualificationsId", "OpportunitiesId")
                        .HasName("pk_qualification_volunteer_opportunity");

                    b.HasIndex("OpportunitiesId")
                        .HasDatabaseName("ix_qualification_volunteer_opportunity_opportunities_id");

                    b.ToTable("qualification_volunteer_opportunity", "public");
                });
            ...
            modelBuilder.Entity("WeCare.Domain.Models.ParticipationCertificate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("AuthenticityCode")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("authenticity_code");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_participation_certificates");

                    b.HasIndex("RegistrationId")
                        .HasDatabaseName("ix_participation_certificates_registration_id");

                    b.ToTable("participation_certificates", "public");
                });

            modelBuilder.Entity("WeCare.Domain.Models.Qualification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CandidateQualification", b =>
                {
                    b.HasOne("WeCare.Domain.Models.Candidate", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_candidate_qualification_users_candidates_id");

                    b.HasOne("WeCare.Domain.Models.Qualification", null)
                        .WithMany()
                        .HasForeignKey("QualificationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_candidate_qualification_qualification_qualifications_id");
                });
            ...
            modelBuilder.Entity("ParticipationCertificateQualification", b =>
                {
                    b.HasOne("WeCare.Domain.Models.Qualification", null)
                        .WithMany()
                        .HasForeignKey("DisplayedQualificationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_participation_certificate_qualification_qualification_displ");

                    b.HasOne("WeCare.Domain.Models.ParticipationCertificate", null)
                        .WithMany()
                        .HasForeignKey("ParticipationCertificatesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_participation_certificate_qualification_participation_certi");
                });
            ...
            modelBuilder.Entity("QualificationVolunteerOpportunity", b =>
                {
                    b.HasOne("WeCare.Domain.Models.Qualification", null)
                        .WithMany()
                        .HasForeignKey("DesirableQualificationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_qualification_volunteer_opportunity_qualification_desirable");
                    ...
                    b.HasOne("WeCare.Domain.Models.VolunteerOpportunity", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_qualification_volunteer_opportunity_volunteer_opportunities");
                });
            ...
            modelBuilder.Entity("WeCare.Domain.Models.IssueReport", b =>
                {
                    b.HasOne("WeCare.Domain.Models.VolunteerOpportunity", "Opportunity")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_issue_reports_volunteer_opportunities_opportunity_id");
            ...
            modelBuilder.Entity("WeCare.Domain.Models.OpportunityInvitation", b =>
                {
                    ...
                    b.HasOne("WeCare.Domain.Models.VolunteerOpportunity", "Opportunity")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_opportunity_invitation_volunteer_opportunities_opportunity_");
            ...
            modelBuilder.Entity("WeCare.Domain.Models.OpportunityRegistration", b =>
                {
                    ...
                    b.HasOne("WeCare.Domain.Models.VolunteerOpportunity", "Opportunity")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_opportunity_registrations_volunteer_opportunities_opportuni");
            ...
            modelBuilder.Entity("WeCare.Domain.Models.ParticipationCertificate", b =>
                {
                    b.HasOne("WeCare.Domain.Models.OpportunityRegistration", "Registration")
                        .WithMany()
                        .HasForeignKey("RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_participation_certificates_opportunity_registrations_regist");
